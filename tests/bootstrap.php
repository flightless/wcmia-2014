...
$GLOBALS['wp_tests_options'] = array(
	'active_plugins' => array(
		basename(dirname(__DIR__)).'/demo-importer.php',
	),
...
// plugins directory in the http://develop.svn.wordpress.org/trunk/ repo
...
include_once('UserImporter_UnitTestCase.php');