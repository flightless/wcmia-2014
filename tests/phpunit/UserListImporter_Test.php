...
/**
 * Class UserListImporter_Test
 */
class UserListImporter_Test extends UserImporter_UnitTestCase {
	public function test_import_list() {
		...
		$importer = new UserListImporter($users);
	...
	public function test_response() {
		...
		$this->assertInstanceOf( __NAMESPACE__.'\MessageCollection', $response );
